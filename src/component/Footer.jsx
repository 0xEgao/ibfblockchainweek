        ...
        <footer className="relative bg-black text-gray-300 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
                ...
                <div className="flex justify-center space-x-6 mb-16">
                    <a href="https://x.com/IBF_Community?t=33pZSiTWdG5aNDt_4xHKLQ&s=09" className="bg-[#1a1a1a] p-3 rounded-full hover:bg-[#6366f1] hover:text-white transition-all duration-300 group">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" 
                            className="group-hover:rotate-12 transition-transform duration-300">
                            <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/>
                        </svg>
                    </a>
                    <a href="https://www.linkedin.com/company/indian-blockchain-fraternity/" className="bg-[#1a1a1a] p-3 rounded-full hover:bg-[#6366f1] hover:text-white transition-all duration-300 group">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
                            className="group-hover:rotate-12 transition-transform duration-300">
                    ...
                    <a href="https://www.instagram.com/ibf.bu/" className="bg-[#1a1a1a] p-3 rounded-full hover:bg-[#6366f1] hover:text-white transition-all duration-300 group">
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
        className="group-hover:rotate-12 transition-transform duration-300">
